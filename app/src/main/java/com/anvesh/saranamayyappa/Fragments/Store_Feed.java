...
import com.anvesh.saranamayyappa.activity.Commercial_inner;
 ...
 */
public class Store_Feed extends Fragment implements View.OnClickListener, UpdateVolleyData, SwipeRefreshLayout.OnRefreshListener {
    RecyclerView R1;
    ...
    private void findViews(View root) {
        ...
        if(!((Commercial_inner) getActivity()).isOwner()){postBar.setVisibility(View.GONE);}
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.write_post:
                ...
                intent2.putExtra("classType","sfeed");
    ...
    private void callFeeds() {
        String serviceUrl = AyyappaConstants.AYYAPPA_STORE_FEED + "userId=" + AyyappaPref.getUserId() + "&storeId=" + AyyappaPref.getStoreId() ;
        VolleySingleton.getInstance(getContext()).addToQueueWithJsonRequest(null, serviceUrl, getContext(), Store_Feed.this);
